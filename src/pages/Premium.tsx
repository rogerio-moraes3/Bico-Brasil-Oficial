      ...
      <main id="main-content" className="flex-grow container mx-auto px-4 py-8 pb-20 md:pb-8">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16 max-w-7xl mx-auto">
            <Card className="relative border-2 border-primary hover:border-primary/80 hover:shadow-[0_0_30px_hsl(var(--xp-primary-glow))] transition-all duration-300 flex flex-col hover:-translate-y-1">
              <CardHeader className="pb-4">
                <div className="flex items-center justify-between mb-2">
                  <CardTitle className="text-2xl font-bold text-foreground">Premium</CardTitle>
                  <div className="absolute top-0 right-0 bg-primary text-primary-foreground px-4 py-1.5 text-[10px] font-black uppercase tracking-wider rounded-bl-lg shadow-lg">
                    POPULAR
                  </div>
                </div>
            ...
            <Card className="relative border-2 border-primary hover:border-primary/80 hover:shadow-[0_0_40px_hsl(var(--xp-primary-glow))] transition-all duration-300 flex flex-col overflow-hidden hover:-translate-y-1">
            ...
            <Card className="relative border-2 border-primary hover:border-primary/80 hover:shadow-[0_0_30px_hsl(var(--xp-primary-glow))] transition-all duration-300 flex flex-col overflow-hidden hover:-translate-y-1">
