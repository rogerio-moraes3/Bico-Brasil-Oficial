...
export const Header = () => {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 w-full bg-white/96 dark:bg-background/95 text-foreground backdrop-blur-xl shadow-sm md:shadow-md overflow-visible" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
