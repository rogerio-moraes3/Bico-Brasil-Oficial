...
export const Header = () => {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 w-full bg-white/95 dark:bg-background/95 text-foreground backdrop-blur-xl shadow-sm shadow-[0_1px_16px_-6px_hsl(var(--xp-primary)/0.07)] overflow-visible" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
