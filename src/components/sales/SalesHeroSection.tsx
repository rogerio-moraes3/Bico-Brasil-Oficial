        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center mt-6">
            <button
              ...
              className="h-12 w-full sm:w-auto sm:min-w-[200px] px-6 border-[3px] border-primary dark:border-white text-primary dark:text-white bg-white dark:bg-white/10 hover:bg-primary hover:text-white dark:hover:bg-white dark:hover:text-primary font-semibold rounded-lg transition-all flex items-center justify-center gap-2"
            >
            ...
            <button
              ref={offerButtonRef}
              onClick={() => navigate("/app")}
              className="h-12 w-full sm:w-auto sm:min-w-[200px] px-6 border-[3px] border-orange-500 dark:border-white text-orange-500 dark:text-white bg-white dark:bg-white/10 hover:bg-orange-500 hover:text-white dark:hover:bg-white dark:hover:text-primary font-semibold rounded-lg transition-all flex items-center justify-center gap-2"
            >
