export const InstitutionalBlock = () => {
  return (
    <section className="bg-[#d4fddf] dark:bg-gradient-to-br dark:from-slate-900 dark:via-blue-950 dark:to-blue-900 py-20 px-6 md:px-12 pb-32">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-slate-600 dark:text-blue-100 max-w-4xl mx-auto mb-14 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <div className="bg-white dark:bg-blue-900 border-2 border-slate-200 dark:border-blue-700 rounded-xl p-8 shadow-md">
