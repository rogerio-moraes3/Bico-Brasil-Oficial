...
export const SecuritySection = () => {
  return (
    <section className="py-14 md:py-24 bg-[#F1F5F9] dark:bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto">
          {securityFeatures.map((feature, index) => (
            <div
              key={index}
              className="bg-card border border-border rounded-2xl p-5 shadow-sm hover:shadow-[0_4px_24px_-6px_hsl(var(--xp-primary)/0.12)] hover:border-primary/25 transition-all duration-300 group card-lift"
            >
