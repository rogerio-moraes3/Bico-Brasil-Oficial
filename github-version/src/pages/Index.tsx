      ...
      <div className="min-h-screen flex flex-col bg-white dark:bg-slate-950 relative">
        ...
        <div className="flex-1 flex flex-col md:flex-row relative z-10">
          <div
            ...
            className="relative flex-1 bg-gradient-to-br from-blue-600 to-blue-700 dark:from-[#0838C7] dark:to-[#062D9E] flex flex-col items-center justify-center text-white p-8 cursor-pointer hover:from-blue-700 hover:to-blue-800 dark:hover:from-[#062D9E] dark:hover:to-[#0838C7] transition-all duration-300 active:scale-95 min-h-[45vh] md:min-h-[70vh] overflow-hidden"
          >
            ...
            <div className="relative z-10 flex flex-col items-center gap-3 transform hover:scale-105 transition-transform duration-300">
              <Megaphone size={48} className="drop-shadow-lg text-white" />
              <h2 className="text-2xl md:text-2xl font-bold text-center drop-shadow-md text-white">Anunciar um bico</h2>
              <p className="text-sm md:text-base text-center max-w-md opacity-95 text-white">
          ...
          <div
            ...
            className="relative flex-1 bg-gradient-to-br from-green-600 to-green-700 dark:from-green-600 dark:to-green-700 flex flex-col items-center justify-center text-white p-8 cursor-pointer hover:from-green-700 hover:to-green-800 dark:hover:from-green-700 dark:hover:to-green-600 transition-all duration-300 active:scale-95 min-h-[45vh] md:min-h-[70vh] overflow-hidden"
          >
            {/* Removed texture effects for clean solid color */}

            <div className="relative z-10 flex flex-col items-center gap-3 transform hover:scale-105 transition-transform duration-300">
              <Hammer size={48} className="drop-shadow-lg text-white" />
              <h2 className="text-2xl md:text-2xl font-bold text-center drop-shadow-md text-white">Fazer um bico</h2>
              <p className="text-sm md:text-base text-center max-w-md opacity-95 text-white">
